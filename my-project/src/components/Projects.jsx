...
function Projects() {
    ...
    <figure className="px-2 pt-2">
        <img src="../src/img/CHONITOS LOGO.jpg" alt="" className="rounded-xl" />
    </figure>
    ...
    <div className="card ml-10 mr-10 my-10 mb-10 w-72 bg-slate-900 shadow-xl ">
    <figure className="px-2 pt-2">
        <img src="" alt="" className=" text-slate-300 bg-slate-900 hover:bg-black active:bg-black" />
    </figure>
    <div className="card-body items-center text-center text-slate-300">
        <h2 className="card-title"></h2>
        <p></p>
        <div className="card-actions">
        <button className="btn text-slate-300 bg-slate-900 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300 hover:bg-black active:bg-black">LINK</button>
        </div>
    </div>
    </div>
